...
3. Execute `git clone git@github.com:Lunatrius/CrystalWing.git`. This will download CrystalWing's source into `mcdev`.
...
#### Compile CrystalWing
1. Execute `gradle setupDevWorkspace`. This sets up Forge and downloads the necessary libraries to build CrystalWing. This might take some time, be patient.
