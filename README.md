...
## Links of Interest
 ...
 - [Forge Player Downloads](http://bspk.rs/MC/CrystalWing_Forge/index.html) - for Minecraft players to use
 - [Developer Downloads](http://bspk.rs/MC/CrystalWing_Forge/deobf/index.html) - for developers to use in an IDE such as Eclipse
 - [Issue Tracking System](https://github.com/bspkrs/CrystalWing/issues)
 - [Contributing](#contributing) - for those that want to help out  
 - [License](https://raw.github.com/bspkrs/CrystalWing/master/src/main/resources/LICENSE)
  
### Technical Info
 - [Setup Java](#setup-java)
 - [Setup Gradle](#setup-gradle)
 - [Setup Git](#setup-git)
 - [Setup CrystalWing](#setup-crystalwing)
 - [Compile CrystalWing](#compile-crystalwing)
 - [Updating Your Repository](#updating-your-repository)

#### Setup Java
The Java JDK is used to compile CrystalWing.
...
#### Setup Gradle
Gradle is used to execute the various build tasks when compiling CrystalWing.
...
#### Setup Git
Git is used to clone CrystalWing and update your local copy.
...
2. Navigate to a place where you want to download CrystalWing's source (eg `C:\Development\Github\Minecraft\`) by executing `cd [folder location]`. This location is known as `mcdev` from now on.
3. Execute `git clone git@github.com:bspkrs/CrystalWing.git`. This will download CrystalWing's source into `mcdev`.
4. Right now, you should have a directory that looks something like:

***
    mcdev
    \-CrystalWing
        \-CrystalWing's files (should have build.gradle)
***

#### Compile CrystalWing
1. Execute `gradle setupDecompWorkspace`. This sets up Forge and downloads the necessary libraries to build CrystalWing. This might take some time, be patient.
    * You will generally only have to do this once until the Forge version in `build.properties` changes.
2. Execute `gradle build`. If you did everything right, `BUILD SUCCESSFUL` will be displayed after it finishes. This should be relatively quick.
    * If you see `BUILD FAILED`, check the error output (it should be right around `BUILD FAILED`), fix everything (if possible), and try again.
3. Go to `mcdev\CrystalWing\build\libs`.
    * You should see a `.jar` file named `[#.#.#]CrystalWing-<version>.jar`.
